...
def preprocess(data):
    ...
    # Adjust the format to match cleaned date strings
    ...
    # Add a column for sentiment analysis using VADER
    analyzer = SentimentIntensityAnalyzer()
    df['vader_sentiment'] = df['message'].apply(lambda msg: analyzer.polarity_scores(msg)['compound'])
